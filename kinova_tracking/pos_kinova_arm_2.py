...
if __name__ == "__main__":
    ...
    ik_with_floating_base = IK(model_path_without_kinova, points, labels_markers)
    ...
    ik_without_floating_base = IK(new_biomod_file_wu, points, labels_markers)
    ...
    b1.load_experimental_markers(markers[:, :, :2])
    ...
    #     biorbd_model_merge, markers_names, experimental_markers_data, q_first_ik[:, :100]
    # )
    #
