...
def IK_Kinova(
    ...
    def objective_function_param(x, q_support_ulna, biorbd_model, p0, nb_frames):
       for i in nb_frames:
           q_i_thilde = 1
    ...
    while jspkoimaitre:
        param_opt = optimize.minimize(
            ...
            args=(biorbd_model, p0, nb_frames),
            x0=q_support_ulna,
            bounds=bounds,
            method="trust-constr",
            jac="3-point",
        ...
        for f in range(nb_frames):
            ...
            IK_i = optimize.minimize(
                ...
                args=(biorbd_model, q_ik_1[: , f], param_opt.x, markers[:, 14:, f], markers[:, 0:14, f]), # todo: automatiser slicing
                x0=x0,
                bounds=bounds,
                method="trust-constr",
                jac="3-point",
