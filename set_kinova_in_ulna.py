...
# modify) So, we want to find the rototrans ( aka homogeneous transform) of ulna and the support form local to global
# coordinates.
...
# Be aware taht Rototrans_matrix_world_ulna.transpose() would give the wrong matrix
...
# we have Rototrans_matrix_ulna_support, so Position_in_ulna = Rototrans_matrix_ulna_support * Position_in_support
